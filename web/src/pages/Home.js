              ...
              <ul className='home-ul'>
                ...
                <li className='home-li'>
                    <div className='midDiv'>
                        ...
                        <ul>
                            <li>
                                <HomePageBox url="/report" imgUrl="https://images-ext-1.discordapp.net/external/LzIwFDsWK535BZmekN-KK9Em52BoH923-deIjJ0sDBw/http/www.brsmeas.org/Portals/2/images/news/Mountains_plastic.jpg" imgAlt='pollutionImage' title="Pollution Report Feature"  />                            
                            </li>
                            <li>
